...
export default function CollectionsHomeClient() {
    ...
    const fetchCollections = async () => {
      ...
      try {
        ...
        const mappedCollections: Collection[] = data.map((col: any) => ({
          ...
          slug: col.slug,
          productIds: (col.productIds || []).map(String),
      ...
      <main className="max-w-[1440px] mx-auto w-full min-w-0 px-3 sm:px-4 md:px-10 lg:px-20 py-4 sm:py-6 space-y-8">
        ...
        {collections.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-gray-500 mb-6">Collections will appear here once they are created.</p>
            <Link
              href="/products"
